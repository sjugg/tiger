    		...
    		<div id="joinUs_center_5">
    			...
    			<div class="joinUs_center_5_form">
    				<form action="" onsubmit="return checkForm();">
	    				<dl><dd>公司名称<input type="text" id="companyName" value="请输入您的公司名称" onfocus="if (this.value == '请输入您的公司名称') {this.value = '';}" onblur="if (this.value == '') {this.value = '请输入您的公司名称';}"/></dd></dl>
	    				<dl><dd>您的电话<input type="text" id="companyTel" value="请输入您的手机号码" onfocus="if (this.value == '请输入您的手机号码') {this.value = '';}" onblur="if (this.value == '') {this.value = '请输入您的手机号码';}"/></dd></dl>
	    				<dl><dd>您的称呼<input type="text" id="companyUserName" value="请输入您的称呼" onfocus="if (this.value == '请输入您的称呼') {this.value = '';}" onblur="if (this.value == '') {this.value = '请输入您的称呼';}"/></dd></dl>
	    				<dl><dd>所在城市<input type="text" id="companyCity" value="请输入您所在的城市" onfocus="if (this.value == '请输入您所在的城市') {this.value = '';}" onblur="if (this.value == '') {this.value = '请输入您所在的城市';}"/></dd></dl>
	    				<dl><dd class="button"><input type="submit" value="确认提交"/></dd></dl>
    				</form>
    			</div>
