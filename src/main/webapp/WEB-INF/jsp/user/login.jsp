    			...
    			<div class="login_form">
    				...
    				<div class="right">
    					...
    					<form action="" method="post" id="loginForm">
    						...
    						<dl class="input"><dd ><input name="tel" id="tel"/></dd></dl>
    						<dl class="text"><dd class="password" >请输入密码</dd><dd class="forgot">忘记密码?</dd></dl>
    						<dl class="input"><dd><input name="password" id="password" /></dd></dl>
    						<dl class="submit input"><dd><input type="button" id="loginBotton" value="登录"/></dd><dd>没有账号?去<a href="register">注册</a></dd></dl>
    					</form>
    				</div>
    			</div>
