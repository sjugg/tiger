...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="width:855px;margin:0 auto;">
    <form action="admin/strategy/addStrategy" method="post">
    	<select name="strategyKindsid">
    	<c:forEach items="${strategykindsList}" var="kinds">
    	<option value="${kinds.strategykindsId }" >${kinds.strategykindsName }</option>
    	</c:forEach>
    	
    	</select><br/>
    	名称：<input type="text" name="strategyName"/><br/>
	            图片：<input type="text" name="strategyPicture" id="upFile"/>
	            <input type="button" value="上传" onclick="up()"/><br/>
	           描述：<input type="text" name="strategyInfo"/><br/>
	          文章：<TEXTAREA id="myEditor" name="strategyContent"></TEXTAREA>  
